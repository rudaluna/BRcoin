...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s brcointest-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  brcointest-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded brcointest transaction") + "\n" +
              "  brcointest-tx [options] -create [commands]   " + _("Create hex-encoded brcointest transaction") + "\n" +
              "\n";
