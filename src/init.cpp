...
void Shutdown()
{
    ...
    RenameThread("brcointest-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/brcointest-project/brcointest>";
    const std::string URL_WEBSITE = "<https://brcointest.org>";
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("brcointest-loadblk");
    CImportingNow imp;
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("BRcointest version %s\n", FormatFullVersion());
}
