...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.brcointest.loshan.co.uk", true));
        vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        vSeeds.push_back(CDNSSeedData("brcointesttools.com", "dnsseed.brcointesttools.com"));
        vSeeds.push_back(CDNSSeedData("brcointestpool.org", "dnsseed.brcointestpool.org"));
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("brcointesttools.com", "testnet-seed.brcointesttools.com"));
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.brcointest.loshan.co.uk", true));
